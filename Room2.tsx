...
Command: npx gltfjsx@6.1.11 ./public/models/room2.glb --transform -t --keepnames
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/room2-transformed.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      <mesh name="Bin" geometry={nodes.Bin.geometry} material={materials['Material.001']} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
